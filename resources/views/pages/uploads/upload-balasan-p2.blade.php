...
<div class="card bg-base-100 shadow-xl max-w-4xl mx-auto">
    <div class="card-body">
        <h2 class="card-title text-2xl font-bold mb-6 text-[#102C57]">Form Upload Surat Balasan P2</h2>

        {{-- Pastikan ada enctype="multipart/form-data" untuk upload file --}}
        <form action="{{ route('balasanP2.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
